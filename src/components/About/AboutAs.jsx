...
import SLE_ISO from '../../assets/img/content/Firma-bureauveritas -2025.gif'
                ...
                <div className="relative max-w-3xl px-10 text-center text-white auto lg:px-0">
                    <div className="flex flex-col w-full md:flex-row">
                        ...
                        <div className="relative top-0 right-0 h-24 mt-12 md:mt-0 md:h-10 mx-auto">
                            <img src={ SLE_ISO } className="object-cover mt-3 mr-5 h-30 lg:h-32 md:my-auto md:mr-0" alt='logo starlight electronics' />
                        </div>
                    </div>
