        ...
        <>            
            ...
            <section className="w-full pt-7 pb-7 md:pt-20 md:pb-24">
                ...
                <div className='max-w-screen-xl mx-auto sm:px-20 md:px-32 lg:px-16'>
                    {/* <h2 className="mt-16 mb-4 text-center text-3xl font-bold leading-tight tracking-tight sm:text-4xl font-heading">Valores <span className='text-sky-600'>corporativos</span></h2> */}
                    
                    {/* Create a list with 6 items and add a new item with the + button. */}
                    {/* <ul className="mt-4">
                        <li className="mb-4 flex flex-col gap-y-10 mx-auto">
                            ...
                            <div className="flex items-center ml-32">
                                ...
                                <div className="flex flex-shrink-0 ml-30">
                                    <svg className="h-6 w-6 text-sky-600" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M9 12l2 2 4-4m5.618-4.016A11.955 11.955 0 0112 2.944a11.955 11.955 0 01-8.618 3.04A12.02 12.02 0 003 9c0 5.591 3.824 10.29 9 11.622 5.176-1.332 9-6.03 9-11.622 0-1.042-.133-2.052-.382-3.016z" />
                                    </svg>
                                    <p> Calidad </p>
                            ...
                            <div className="flex items-center ml-32 gap-60">
                                <div className="flex flex-shrink-0">
                                    <svg className="h-6 w-6 text-sky-600" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M9 12l2 2 4-4m5.618-4.016A11.955 11.955 0 0112 2.944a11.955 11.955 0 01-8.618 3.04A12.02 12.02 0 003 9c0 5.591 3.824 10.29 9 11.622 5.176-1.332 9-6.03 9-11.622 0-1.042-.133-2.052-.382-3.016z" />
                                    </svg>
                            ...
                            <div className="flex items-center mx-auto gap-36">
                                <div className="flex flex-shrink-0">
                                    <svg className="h-6 w-6 text-sky-600" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M9 12l2 2 4-4m5.618-4.016A11.955 11.955 0 0112 2.944a11.955 11.955 0 01-8.618 3.04A12.02 12.02 0 003 9c0 5.591 3.824 10.29 9 11.622 5.176-1.332 9-6.03 9-11.622 0-1.042-.133-2.052-.382-3.016z" />
                                    </svg>
