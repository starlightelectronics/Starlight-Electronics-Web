    ...
    <footer className="bg-[#060d1f] border-t border-sky-900/30 mt-16 text-white">
      <div className="container mx-auto px-8 md:px-14 lg:px-32 py-14">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-14 max-w-5xl mx-auto">
          ...
          {/* Columna 2 - Oficinas */}
          <div>
            <h4 className="text-sky-400 font-bold text-xs uppercase tracking-widest mb-6">Oficinas</h4>
          ...
          {/* Columna 3 - Teléfonos y Email */}
          <div>
            <h4 className="text-sky-400 font-bold text-xs uppercase tracking-widest mb-6">Contacto</h4>
