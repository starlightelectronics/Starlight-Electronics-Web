            ...
            <>
                {/* <nav className="align-middle md:inline-block lg:mr-24 lg:w-2 fixed left-percentage hidden xl:block">
                    <div className="absolute left-50 transform -translate-x-1/2 space-y-6 mt-36">
                        ...
                        <a href="#location" className="nav-dot block w-7 h-7 rounded-full border-4 border-nav bg-body">
                            <span className="bg-black px-2 py-1 rounded-md ml-10 opacity-0">Ubicación</span>
                        </a>
                    </div>
                </nav> */}
            </>
