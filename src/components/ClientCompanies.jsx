...
export const ClientCompanies = () => {
    ...
    return (
        ...
        <div name='skills' className='w-full h-screen text-2xl text-gray-300'>
        {/* Container */}
        <div className='max-w-10 sm:px-52 mx-auto p-4 flex flex-col justify-center w-full h-full'>
            <div>
                <p className='text-4xl font-bold inline border-b-4 border-blue-600 '>Business</p>
                <p className='py-4'> Empresas que confian en nosotros </p>
            </div>

            <div className='w-full grid grid-cols-2 sm:grid-cols-4 gap-4 text-center py-8'>
                <div className='shadow-md shadow-[#040c16] hover:scale-110 duration-500'>
                    <img className='w-40 mx-auto' src={client} alt="HTML icon" />
                    <p className='my-4'>Empresa</p>
                </div>
                <div className='shadow-md shadow-[#040c16] hover:scale-110 duration-500'>
                    <img className='w-40 mx-auto' src={client} alt="HTML icon" />
                    <p className='my-4'>Empresa X</p>
                </div>
                <div className='shadow-md shadow-[#040c16] hover:scale-110 duration-500'>
                    <img className='w-40 mx-auto' src={client} alt="HTML icon" />
                    <p className='my-4'>Empresa X</p>
