		...
		<div className="container mt-16 flex justify-between items-center mx-auto px-8 md:px-14 lg:px-24 w-full">
			<div className="flex flex-wrap md:flex-nowrap">
				...
				<div className="flex flex-wrap lg:ml-20 justify-center md:justify-start max-w-xl mt-0 md:my-36">
					<h1 className="font-bold text-5xl md:text-6xl lg:text-7xl text-center md:text-left">Starlight <br /> construyendo experiencias.</h1>
				...
				<img src={ globalposition } alt="logo2" className="w-2/4 mt-12 md:absolute -mt-6 md:mt-0 right-0 -z-1" useMap='#positionglobal' />

				<map name="positionglobal">
					<area shape="rect" coords="100, 100, 1500, 1500" href="https://www.controlavllc.com/" alt="positionglobal" />
				</map>
